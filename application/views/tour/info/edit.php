<div class="container top">
    ...
    <div class="row">
        ...
        echo form_open_multipart('tour/info/update', $attributes);
        ...
        echo form_textarea('tour_guide_info', $tour_info_data[0]['tour_guide_info'], 'placeholder="tour_guide_info" class="form-control"');
        echo '</div>';
