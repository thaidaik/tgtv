<div class="container top">
    ...
    ?>
    <div class="col-sm-6">
    <div class="control-group"><label class="control-label required" for="image">Image</label>
        <input type="file" name="image" value="" class="form-control">
    </div>
    <div class="control-group"><label class="control-label required" for="username">Username</label>
        <input type="text" name="username" value="<?php echo $member['0']['user_name']; ?>" placeholder="Username" class="form-control">
    </div>
    <div class="control-group"><label class="control-label required" for="name">Name</label>
    ...
    <div class="control-group"><label class="control-label required" for="sex">Sex</label>
        <?php echo form_dropdown('sex', $user_sex, $member['0']['sex'], 'class="form-control"'); ?>
    </div>
    <div class="control-group"><label class="control-label required" for="address">Address</label>
    ...
    <div class="control-group"><label class="control-label required" for="birthday">Birthday</label>
    ...
    <div class="control-group"><label class="control-label required" for="identificatio">Identificatio ID</label>
    ...
    <div class="control-group"><label class="control-label required" for="passport">Passport</label>
    ...
    <div class="control-group"><label class="control-label required" for="role">Select Role</label>
