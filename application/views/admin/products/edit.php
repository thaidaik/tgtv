      ...
      ?>
        <fieldset>
          <div class="control-group">
            ...
            <div class="controls">
              <input type="text" id="" class="form-control" name="description" value="<?php echo $product[0]['description']; ?>" >
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <input type="text" id="" class="form-control" name="stock" value="<?php echo $product[0]['stock']; ?>">
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <input type="text" id="" class="form-control" name="cost_price" value="<?php echo $product[0]['cost_price'];?>">
              <!--<span class="help-inline">Cost Price</span>-->
            </div>
          </div>
          <div class="control-group">
            ...
            <div class="controls">
              <input type="text" class="form-control" name="sell_price" value="<?php echo $product[0]['sell_price']; ?>">
